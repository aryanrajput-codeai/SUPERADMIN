            ...
            >
              ...
              <form onSubmit={handleLogin} className="space-y-5 text-xs text-slate-600">
                ...
                <button
                  ...
                  className={`w-full bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white font-bold py-3.5 rounded-2xl transition-all shadow-lg shadow-indigo-600/15 hover:shadow-indigo-600/25 cursor-pointer flex items-center justify-center space-x-2 text-sm mt-2 ${isLoggingIn ? 'opacity-70 cursor-not-allowed' : ''}`}
                >
                  {isLoggingIn ? (
                    <>
